...
$tablica=$tabl36; 
$dathfirst=$_SESSION['dathfirst'];
$dathsecnd=$_SESSION['dathsecnd'];
...
$filtr1="where (Datasoob >= '$dathfirst') AND (Datasoob <= '$dathsecnd')"; //
}
...
if ($filtr=="vse") {
echo "<CAPTION> Хронология сообщений за весь период </CAPTION>";
} else {
echo "<CAPTION> Хронология сообшений с $dathfirst по $dathsecnd </CAPTION>";
}

echo "<tr>
<td align=center>N пользователя</td>
